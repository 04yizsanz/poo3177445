...
class Carro{
    ...
    //metodos => acciones que hace el carro(funciones)
...
echo "El color de mi caro es: ".$carroEspecial->getColor(). "<br>";
...
echo "ahora la velocidad despues de frenar mi carro: ".$carroEspecial->getVelocidad(). "<br>";